...
const JURISDICTION_ENUM = Object.keys(JURISDICTIONS) as [string, ...string[]];
...
export function createMcpServer(): McpServer {
  const server = new McpServer(
    { name: "passionstate-nexus", version: "0.1.0" },
    { capabilities: { tools: {} } }
  );
  ...
  server.registerTool(
    "passionstate_update_quantum_pass",
    {
  ...
  server.registerTool(
    "passionstate_create_openchamber",
    {
  ...
  server.registerTool(
    "passionstate_validate_insurance_coverage",
    {
  ...
  server.registerTool(
    "passionstate_get_license_requirements",
    {
  ...
  server.registerTool(
    "passionstate_submit_theory_exam",
    {
  ...
  server.registerTool(
    "passionstate_submit_practical_assessment",
    {
  ...
  server.registerTool(
    "passionstate_apply_specialized_endorsement",
    {
  ...
  server.registerTool(
    "passionstate_file_license_appeal",
    {
