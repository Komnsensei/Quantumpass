...
export function registerEmbodiedSystemTool(server, systems, archive) {
    server.registerTool("passionstate_register_embodied_system", {
        title: "Register Embodied System",
        description: "Registers an embodied system (robot, drone, AI agent) with the Passion State, assigning a unique identifier and establishing its legal presence.",
