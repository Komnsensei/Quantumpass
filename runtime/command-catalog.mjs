export const COMMAND_CATALOG = [
  ...
  { name: "/brain", group: "autonomy", description: "Free Brain (freebrain Python cascade): chat | goal | providers" },
  { name: "/brain chat", group: "autonomy", description: "One-shot freebrain chat" },
  { name: "/brain goal", group: "autonomy", description: "Goal-directed freebrain tool loop" },
  { name: "/brain providers", group: "autonomy", description: "Show freebrain cascade chain" },
